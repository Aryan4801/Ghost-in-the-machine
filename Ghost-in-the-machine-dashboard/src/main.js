...
document.querySelector('#app').innerHTML = `
  ...
  <main>
    ...
    <section id="tech-stack" class="tech-stack-section container">
      <div class="section-header">
        <h2 class="text-glow">Engineered Deception</h2>
        <p>A sophisticated integration of modern technologies powering real-time adversary analysis.</p>
      </div>

      <div class="tech-grid">
        <div class="tech-card glass-panel">
          <div class="tech-card-header">
            <span class="tech-icon text-glow">⬡</span>
            <h3 class="tech-title text-glow">Attack Surfaces</h3>
          </div>
          <ul class="tech-list-items">
            <li><strong>Node.js & Express:</strong> Powers the responsive web terminal environment</li>
            <li><strong>Socket.IO:</strong> Real-time bi-directional event pipeline for keystroke logging</li>
            <li><strong>Python & Paramiko:</strong> Emulates a fully functional, deep SSH honeypot server</li>
          </ul>
        </div>
        ...
        <div class="tech-card glass-panel">
          <div class="tech-card-header">
            <span class="tech-icon text-glow">⬡</span>
            <h3 class="tech-title text-glow">Intelligence & AI</h3>
          </div>
          <ul class="tech-list-items">
            <li><strong>OpenAI & Ollama:</strong> LLM-orchestrated response engine mimicking actual vulnerabilities</li>
            <li><strong>VADER NLP:</strong> Custom security lexicon for real-time sentiment analysis</li>
            <li><strong>MITRE ATT&CK:</strong> Automatic technique mapping and fingerprinting</li>
          </ul>
        </div>
        ...
        <div class="tech-card glass-panel">
          <div class="tech-card-header">
            <span class="tech-icon text-glow">⬡</span>
            <h3 class="tech-title text-glow">Storage & Core</h3>
          </div>
          <ul class="tech-list-items">
            <li><strong>MongoDB:</strong> High-fidelity session data store and telemetry database</li>
            <li><strong>In-Memory Fallback:</strong> Zero-configuration database for lightweight deployment</li>
            <li><strong>Spline 3D:</strong> Fully interactive, real-time 3D vector lock interface</li>
          </ul>
        </div>
      </div>
    </section>
